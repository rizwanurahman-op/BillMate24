                ...
                <div className="max-w-7xl mx-auto space-y-6">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div className="lg:col-span-2 space-y-6">
                            ...
                            {/* Signature & Company Details - NEW Section */}
                            <Card className="border-0 shadow-xl overflow-hidden bg-white">
                                <CardHeader className="border-b-2 border-purple-500 bg-gradient-to-r from-purple-50 to-indigo-50 pb-5">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <CardTitle className="text-xl md:text-2xl font-bold text-gray-900">
                                                {t('invoices.signature_details')}
                                            </CardTitle>
                                            <p className="text-xs md:text-sm text-gray-600 mt-0.5">
                                                {t('invoices.signature_details_desc')}
                                            </p>
                                        </div>
                                    </div>
                                </CardHeader>
                                <CardContent className="p-6 md:p-8 space-y-6">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                        ...
                                        <div className="space-y-6">
                                            <div className="space-y-2">
                                                <Label htmlFor="signatureName" className="text-sm font-bold text-gray-700 flex items-center gap-2">
                                                    <div className="w-1.5 h-4 bg-indigo-500 rounded-full"></div>
                                                    {t('invoices.signature_label')}
                                                </Label>
                                                <Input
                                                    id="signatureName"
                                                    value={formData.signatureName}
                                                    onChange={(e) => handleInputChange('signatureName', e.target.value)}
                                                    placeholder={t('invoices.signature_label_placeholder')}
                                                    className="h-12 border-2 border-gray-200 focus:border-indigo-500 rounded-xl font-medium"
                                                />
                                                <p className="text-[10px] text-gray-500">
                                                    {t('invoices.signature_tip')}
                                                </p>
                                            </div>
                                            ...
                                            <div className="p-4 bg-purple-50 rounded-xl border border-purple-100 flex items-start gap-3">
                                                ...
                                                <div>
                                                    <p className="text-xs font-bold text-purple-900">PRO TIP</p>
                                                    <p className="text-[10px] text-purple-700 leading-tight">
                                                        Sign clearly on the pad. The signature will be professionally embedded into the "Modern" and "Professional" templates.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
