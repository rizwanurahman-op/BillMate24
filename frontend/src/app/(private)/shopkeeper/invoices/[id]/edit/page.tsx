...
import { ArrowLeft, Plus, Trash2, Save, Eye, FileText, Palette, Sparkles, Loader2, Hash, Calendar, Clock, PenTool, StickyNote, Shield, FileSignature } from 'lucide-react';
...
import { UpdateInvoiceInput, InvoiceItem } from '@/types/invoice';
...
export default function EditInvoicePage() {
    ...
    useEffect(() => {
        if (invoice) {
            setFormData({
                ...
                shopName: invoice.shopName || user?.businessName || '',
                shopAddress: invoice.shopAddress || [user?.address, user?.place].filter(Boolean).join(', ') || '',
                shopPlace: invoice.shopPlace || user?.place || '',
                shopPhone: invoice.shopPhone || user?.phone || '',
                items: invoice.items,
                ...
                total: invoice.total,
                notes: invoice.notes || '',
                notesEnabled: invoice.notesEnabled !== undefined ? invoice.notesEnabled : false,
                terms: invoice.terms || '',
                termsEnabled: invoice.termsEnabled !== undefined ? invoice.termsEnabled : false,
                signature: invoice.signature || '',
                signatureName: invoice.signatureName || '',
                signatureEnabled: invoice.signatureEnabled !== undefined ? invoice.signatureEnabled : false,
    ...
    const updateMutation = useMutation({
        mutationFn: (data: UpdateInvoiceInput) => invoiceApi.update(invoiceId, data),
        onSuccess: (updatedInvoice) => {
            ...
            if (isPreviewing) {
                ...
                toast.success(t('invoices.messages.success_update'));
    ...
    if (isLoadingInvoice) {
        return (
            <div className="min-h-screen bg-gradient-to-br from-gray-50 via-gray-50 to-blue-50 pb-24">
                <Header title={t('invoices.edit_invoice')} />
    ...
    if (!invoice) {
        return (
            <div className="min-h-screen bg-gradient-to-br from-gray-50 via-gray-50 to-blue-50 pb-24">
                ...
                <div className="flex items-center justify-center h-96">
                    <div className="text-center space-y-4">
                        <p className="text-gray-600">{t('invoices.not_found')}</p>
                        <Button onClick={() => router.push('/shopkeeper/invoices')}>
                            {t('common.back')}
                        </Button>
                    </div>
                </div>
            ...
            <div className="p-4 md:p-6">
                    ...
                    <div>
                        <div className="flex items-center gap-2">
                            <h2 className="text-xl md:text-3xl font-bold bg-gradient-to-r from-gray-900 via-blue-900 to-gray-900 bg-clip-text text-transparent">
                                {t('invoices.edit_title')} #{formData.invoiceNumber}
                            </h2>
                ...
                <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                                                ...
                                                <div className="space-y-2">
                                                    ...
                                                    <Input
                                                        ...
                                                        className="h-11 border-2 border-gray-200 focus:border-blue-500 rounded-xl font-bold text-lg"
                                                    />
                                                </div>
                                                ...
                                                <div className="space-y-2">
                                                    ...
                                                    <Input
                                                        ...
                                                        className="h-11 border-2 border-gray-200 focus:border-purple-500 rounded-xl font-medium"
                                                    />
                                                </div>
                                                ...
                                                <div className="space-y-2">
                                                    ...
                                                    <Input
                                                        ...
                                                        className="h-11 border-2 border-gray-200 focus:border-red-500 rounded-xl font-medium"
                                                    />
                                                </div>
                                            </div>
                                        </CardContent>
                                                ...
                                                <div className="space-y-2">
                                                    ...
                                                    <div className="relative">
                                                        ...
                                                        <Input
                                                            ...
                                                            placeholder={t('invoices.customer_email_placeholder')}
                                                ...
                                                <div className="space-y-2">
                                                    ...
                                                    <div className="relative">
                                                        ...
                                                        <Input
                                                            ...
                                                            placeholder={t('invoices.address_placeholder')}
                                                ...
                                                <div className="space-y-2">
                                                    ...
                                                    <div className="grid grid-cols-2 gap-2 p-1 bg-white/5 rounded-lg border border-white/10">
                                                        ...
                                                        >
                                                            ...
                                                            <span>{t('invoices.fixed_short')} ₹</span>
                                                        </button>
                                                    </div>
                                                </div>
                                            ...
                                            <div className="space-y-3 p-3 bg-white/5 rounded-lg border border-white/10">
                                                ...
                                                <div className="grid grid-cols-2 gap-2">
                                                    <div className="space-y-1">
                                                        <Label className="text-xs text-white/60">{t('invoices.rate')} (%)</Label>
                                                        <Input
                                                            type="number"
                            ...
                            <Card className="border-0 shadow-xl overflow-hidden bg-white">
                                ...
                                <CardContent className="p-0">
                                    ...
                                    <div className="md:hidden p-4 space-y-4">
                                        {(formData.items || []).map((item, index) => (
                                            <div key={index} className="p-4 border-2 border-gray-200 rounded-xl space-y-3 bg-white">
                                                <div className="flex items-center justify-between mb-2">
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <span className="font-bold text-gray-700">{t('invoices.item_n', { n: index + 1 })}</span>
                                                    </div>
                                                    {formData.items && formData.items.length > 1 && (
                                                        <Button
                                                            variant="ghost"
                                                ...
                                                <div className="space-y-2">
                                                    <Label className="text-xs text-gray-600">{t('invoices.description')}</Label>
                                                    <Input
                                                        value={item.description}
                                                        onChange={(e) => handleItemChange(index, 'description', e.target.value)}
                                                        placeholder={t('invoices.item_description_placeholder')}
                                                ...
                                                <div className="grid grid-cols-2 gap-3">
                                                    <div className="space-y-2">
                                                        <Label className="text-xs text-gray-600">{t('invoices.quantity')}</Label>
                                                        <Input
                                                            type="number"
                                                            value={item.quantity}
                                                            onChange={(e) => handleItemChange(index, 'quantity', Number(e.target.value))}
                                                            className="h-10 text-center border-2 border-blue-200 focus:border-blue-500 bg-blue-50/50"
                                                        />
                                                    </div>
                                                    <div className="space-y-2">
                                                        <Label className="text-xs text-gray-600">{t('invoices.rate')}</Label>
                                                        <div className="relative">
                                                            ...
                                                            <Input
                                                                ...
                                                                value={item.rate}
                                                                onChange={(e) => handleItemChange(index, 'rate', Number(e.target.value))}
                                                                className="h-10 pl-7 pr-3 text-right border-2 border-purple-200 focus:border-purple-500 bg-purple-50/50"
                                                            />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="pt-2 border-t border-gray-200">
                                                    <div className="flex justify-between items-center">
                                                        <span className="text-sm font-medium text-gray-600">{t('invoices.amount')}</span>
                                                        <span className="text-lg font-black bg-gradient-to-r from-green-700 to-emerald-700 bg-clip-text text-transparent">
                                                            {formatCurrency(item.amount)}
                                                        </span>
                                                    </div>
                                                </div>
                    ...
                    <TabsContent value="signature" className="space-y-6">
                        <Card className="max-w-4xl mx-auto border-0 shadow-2xl overflow-hidden bg-gradient-to-br from-purple-50 via-white to-indigo-50">
                    ...
                    <TabsContent value="notes" className="space-y-6">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            {/* Terms Card */}
                            <Card className="border-0 shadow-2xl overflow-hidden bg-gradient-to-br from-green-50 via-white to-emerald-50">
                                <CardHeader className="border-b-2 border-green-500 bg-gradient-to-r from-green-600/10 via-emerald-600/10 to-green-600/10 pb-6">
                                    <div className="space-y-4">
                                        <div className="flex items-center justify-between">
                                            <div className="flex items-center gap-3">
                                                <div className="p-3 bg-gradient-to-br from-green-600 to-emerald-600 rounded-xl shadow-lg">
                                                ...
                                                <div className="grid grid-cols-1 gap-2">
                                                    {TERMS_SUGGESTIONS.map((suggestion, index) => (
                                                        <button
                                                            ...
                                                            className="text-left p-3 text-xs bg-gradient-to-r from-green-50 to-emerald-50 hover:from-green-100 hover:to-emerald-100 rounded-lg border border-green-200 hover:border-green-400 transition-all text-gray-700 hover:text-gray-900 font-medium"
                                                        >
                                                            {suggestion}
                                                        </button>
                                                    ))}
                            ...
                            >
                                {updateMutation.isPending ? (
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span>{t('invoices.save_changes')}</span>
                                    </div>
                                )}
                            </Button>
                        </div>
