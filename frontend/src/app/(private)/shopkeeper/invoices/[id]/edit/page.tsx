...
import { ArrowLeft, Plus, Trash2, Save, Eye, FileText, Palette, Sparkles, Loader2, Hash, Calendar, Clock } from 'lucide-react';
...
export default function EditInvoicePage() {
    ...
    useEffect(() => {
        if (invoice) {
            setFormData({
                ...
                shopAddress: invoice.shopAddress || user?.address || '',
    ...
    const updateMutation = useMutation({
        ...
        onSuccess: (updatedInvoice) => {
            ...
            router.push(`/shopkeeper/invoices/${updatedInvoice._id}`);
        },
        onError: () => {
                    ...
                    <div className="px-6 py-5 border-t bg-gradient-to-r from-gray-50 to-blue-50/30 backdrop-blur-sm flex-shrink-0">
                        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <Button
                                    onClick={() => { setPreviewOpen(false); handleSubmit(formData.status as 'draft' | 'sent'); }}
                                    disabled={updateMutation.isPending}
